...
WebUI.callTestCase(findTestCase('5 Shipping/Shipping option1'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Review order  Boxes4U/input_Credit card_commerce_paymentpayment_method'))

WebUI.click(findTestObject('Object Repository/Page_Review order  Boxes4U/input_No payment required_op'))
